...
<div id="secondary">
    <?php if (get_theme_option('Display Featured Item') == 1): ?>
        <!-- Featured Item -->
        <div id="featured-item" class="In Evidenza">
            <h2><?php echo __('Oggetto in Evidenza'); ?></h2>
            <?php echo random_featured_items(1); ?>
        </div><!--end featured-item-->
    <?php endif; ?>
    <?php if (get_theme_option('Visualizza Collezione in evidenza')): ?>
        <!-- Featured Collection -->
    ...
    ?>
    <div id="recent-items">
        <h2><?php echo __('Ultimi oggetti inseriti'); ?></h2>
