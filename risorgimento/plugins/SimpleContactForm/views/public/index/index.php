...
<div id="simple-contact">
    ...
    <form name="contact_form" id="contact-form"  method="post" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        <fieldset>
        <div class="field">
        <?php echo $this->formLabel('name', 'Il tuo nome: '); ?>
            <div class='inputs'>
        ...
        <div class="field">
            <?php echo $this->formLabel('email', 'La tua Email: '); ?>
            <div class='inputs'>
        ...
        <div class="field">
          <?php echo $this->formLabel('message', 'Il tuo messaggio: '); ?>
          <div class='inputs'>
        ...
        <div class="field">
          <?php echo $this->formSubmit('send', 'Invia Messaggio'); ?>
        </div>
