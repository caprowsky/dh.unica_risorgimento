<?php
    ...
    list($imgNums, $imgLabels, $imgWidths, $imgHeights, $imgNames) = BookReader::imagesData();
...
<body>
    ...
    //mod for archive.org
    br.imagespath = [<?php echo implode(',', $imgNames);?> ];
    ...
    br.getPageURI = function(index, reduce, rotate) {
	 ...
	 //var url = 'http://www.archive.org/download/BookReader/img/page001.jpg';
	 
	//var imageItem = files_for_item();
	//var url = 'http://unicaome.contabi.it/files/original/15dd28e23098a6db2e9defb98abebbd0.jpeg';
	 var url = br.imagespath[index] ;
        return url;
    }
